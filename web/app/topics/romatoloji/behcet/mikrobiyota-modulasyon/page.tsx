...
export default function Page() {
  const related = PAGES.filter(p => p.href !== "/topics/romatoloji/behcet/mikrobiyota-modulasyon");
  return (
    <div className="mx-auto max-w-3xl p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold">Mikrobiyota modülasyonu: probiyotik/prebiyotik</h1>
