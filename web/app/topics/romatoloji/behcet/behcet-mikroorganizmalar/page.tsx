...
export default function Page() {
  const related = PAGES.filter(p => p.href !== "/topics/romatoloji/behcet/behcet-mikroorganizmalar");
  return (
    <div className="mx-auto max-w-3xl p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold">BH ve mikroorganizmalar (tetikleyiciler)</h1>
