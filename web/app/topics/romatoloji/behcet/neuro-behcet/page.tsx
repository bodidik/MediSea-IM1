...
export default function Page() {
  const related = PAGES.filter(p => p.href !== "/topics/romatoloji/behcet/neuro-behcet");
  return (
    <div className="mx-auto max-w-3xl p-6 space-y-6">
      <header>
        <h1 className="text-2xl font-bold">Nöro-Behçet: klinik spektrum ve görüntüleme</h1>
