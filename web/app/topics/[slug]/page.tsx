...
import RelatedAside from "@/components/topics/RelatedAside";
                ...
                <div key={i} className="rounded-2xl border p-4 bg-white">
                  ...
                  {allowed ? (
                    ...
                    <div className="text-sm text-gray-500 mt-2">
                      ...
                      {plan !== "P" && (
                        <a className="ml-2 underline" href="/premium">Yükselt</a>
                      )}
                    </div>
                  )}
                </div>
        ...
        <aside className="lg:col-span-4">
          <div className="lg:sticky lg:top-6 space-y-4">
            ...
            <div className="rounded-2xl border p-4 bg-white">
              ...
              <a href="/premium" className="inline-block mt-3 px-3 py-2 rounded-lg border text-sm">
                Planları Gör
              </a>
            </div>
          </div>
