...
export default async function Page() {
  const title = "hematoloji"[0].toLocaleUpperCase("tr-TR") + "hematoloji".slice(1);
  ...
  return (
    <main className="max-w-6xl mx-auto p-6">
      ...
      <p className="opacity-70 mb-6">
        Aşağıda hematoloji konu başlıkları listelenmiştir. İsterseniz sayfanın en üstündeki
