...
export const PLAN_BADGES: Record<PlanType, BadgeConfig> = {
  free: { title: "Free", color: "bg-gray-300 text-gray-900", description: "Temel Ã¶zellikler, sÄ±nÄ±rlÄ± eriÅŸim" },
  premium: { title: "Premium", color: "bg-yellow-400 text-yellow-900", description: "TÃ¼m iÃ§eriklere eriÅŸim, geliÅŸmiÅŸ Ã¶zellikler" },
