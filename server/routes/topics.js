...
import {
  list,      // GET    /api/topics           (section, q, page, limit, sort)
...
/* 
 * ÖNEMLİ: Parametreli rotalarla çakışmamak için
 * spesifik yolları önce tanımlıyoruz.
 */
...
// Liste (section/q/limit/page/sort destekli)
router.get("/", list);
