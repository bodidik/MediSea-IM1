...
export default function ChadsVascPage() {
  ...
  else if (score === 1 && state.female) comment = "Kadın 1 = cinsiyet puanı; diğer risklere bakınız.";
  else if (score >= 2 || (score === 1 && !state.female)) comment = "Orta-Yüksek risk; antikoagülasyon düşünülebilir.";
